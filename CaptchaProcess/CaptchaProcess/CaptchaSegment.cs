...
namespace CaptchaSegment
{
    ...
    public class CaptchaSegment
    {
        ...
        public static int ImageHeight = 0;//CAPTCHA.Program.Height;

        public static int ImageWidth = 0;//CAPTCHA.Program.Width;
        ...
        public static Byte[,] CaptchaSegmentFun(Bitmap srcBmp)//, string imageDestPath)
        {
            SegPathList.Clear();

            SegAreaList.Clear();

            ImageHeight = srcBmp.Height;

            ImageWidth = srcBmp.Width;
